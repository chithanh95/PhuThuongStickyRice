using PhuThuongStickyRice.EndToEndTests.Configuration;
using PhuThuongStickyRice.EndToEndTests.Pages;
using OpenQA.Selenium;

namespace PhuThuongStickyRice.EndToEndTests.Navigation
{
