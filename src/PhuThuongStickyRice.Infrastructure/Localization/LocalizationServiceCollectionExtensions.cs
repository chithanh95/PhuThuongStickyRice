...
namespace PhuThuongStickyRice.Infrastructure.Localization
{
    public static class LocalizationServiceCollectionExtensions
    {
        public static IServiceCollection AddPhuThuongStickyRiceLocalization(this IServiceCollection services, LocalizationProviders providers = null)
        {
