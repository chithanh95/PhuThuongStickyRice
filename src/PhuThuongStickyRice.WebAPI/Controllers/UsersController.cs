...
using PhuThuongStickyRice.Application.Users.Commands;
using PhuThuongStickyRice.Application.Users.Queries;
...
namespace PhuThuongStickyRice.WebAPI.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        public UsersController(Dispatcher dispatcher, UserManager<User> userManager,
            ILogger<UsersController> logger, IDateTimeProvider dateTimeProvider,
