...
using PhuThuongStickyRice.WebMVC.Authorization;
using PhuThuongStickyRice.WebMVC.ClaimsTransformations;
using PhuThuongStickyRice.WebMVC.ConfigurationOptions;
using PhuThuongStickyRice.WebMVC.Configurations;
using PhuThuongStickyRice.WebMVC.Filters;
using PhuThuongStickyRice.WebMVC.HttpMessageHandlers;
using PhuThuongStickyRice.WebMVC.Middleware;
using System;
...
namespace PhuThuongStickyRice.WebMVC
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddPhuThuongStickyRiceSignalR(AppSettings);
            ...
            .AddOpenIdConnect(OpenIdConnectDefaults.AuthenticationScheme, options =>
            {
                ...
                options.Scope.Add("PhuThuongStickyRice.WebAPI");
            ...
            var healthChecksBuilder = services.AddHealthChecks()
                .AddSqlServer(connectionString: AppSettings.ConnectionStrings.PhuThuongStickyRice,
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                ...
                endpoints.MapPhuThuongStickyRiceHubs();
            });
        }
    }
}
